"""WEIGHT VARIANT of r10_radial_hinge_calibrated_contrastive — gentlest calibration: LAMBDA_RAD 0.25, LAMBDA_PLACE 0.02 (max margin preservation, ratio ~1.23 per the stationarity sweep)."""
...
_LAMBDA_RAD = 0.25    # radial log-norm match weight. Verified at stationarity in an adversarial
...
_LAMBDA_PLACE = 0.02  # placement hinge weight
