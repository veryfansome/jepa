"""WEIGHT VARIANT of r10_radial_hinge_calibrated_contrastive — radial-only: LAMBDA_PLACE 0 (isolate the norm-match term; no placement hinge pressure)."""
...
_LAMBDA_RAD = 1.0    # radial log-norm match weight. Verified at stationarity in an adversarial
...
_LAMBDA_PLACE = 0.0  # placement hinge weight
